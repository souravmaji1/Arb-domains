      ...
      <Accordion>
        <AccordionSummary
         style={{width:"100%"}}
          ...
          id="panel3a-header"
        >
          <Typography>Benefits of Domain Names ?</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography variant="body2">
      ...
      <Accordion>
        <AccordionSummary
         style={{width:"100%"}}
          ...
          id="panel3a-header"
        >
          <Typography>what network it has been deployed?</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography variant="body2">
            Arbitrum
          ...
          <Typography variant="body2" sx={{ mt: 2}}>
            And smartcontract address (0x9aEf9631d76d7D84Dbe7A676b75C21BF2f855D4C)
          </Typography>
        </AccordionDetails>
      </Accordion>
    </div>
