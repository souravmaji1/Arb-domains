...
const UserClaimed = () => {
    ...
    const renderUsers = () => {
		...
		if (network !== 'BSC Mainnet' && network !== 'Polygon' && network !== 'BNBTest' && network !== 'Ethereum' && network !== 'Mumbai') {
            return (
                <Box sx={{ pt: 8, pb: 6 }}>
                    ...
                    <Typography variant="body1" align="center" color="text.secondary" paragraph>
                        ...
                        <ColorButton align="center" variant="contained" onClick={switchToBNBTest}>
							Login With BSCTest
						</ColorButton>
                        <ColorButton align="center" variant="contained" onClick={switchToMumbai}>
							Login With Mumbai
						</ColorButton>
						</Stack>
                    </Container>
